...
#      columns: 2
  - block: markdown
    ...
    content:
      ...
      text: |-
        #### Works in Progress 
        - ###### {{< spoiler text="Xinbo Lin, Lawrence J. Liu, Eddie Yang, Jinhua Cheng, Han Liu & Taisu Zhang. Forthcoming 2027. Perceiving Techo-legality: Social Attitudes towards the Judicial use of Artificial Intelligence in China and the United States. American Journal of Comparative Law." >}}
        In recent years, court systems in both the United States and China—the two dominant players in the ongoing global Artificial Intelligence (AI) arms race—have begun incorporating AI into their daily operations. This article offers the first survey-based comparison of American and Chinese social perceptions of judicial AI use. Surveying demographically representative samples of both Chinese and American respondents, we find that Chinese respondents hold, on aggregate, significantly more positive perceptions of judicial AI use than do their American peers.

        We also probe the underlying sociocultural reasons for this divergence. We find that it is likely connected to two other divergences: first, Chinese respondents were much more optimistic about the socioeconomic prospects of general AI development than American respondents were. Second, they were also significantly more likely to believe in legal determinacy—that is, they were more likely to believe that legal questions have single, correct answers that can be found through technical reasoning. Other potential explanatory factors, such as legal knowledge, knowledge of AI, or trust in judicial institutions, were also statistically tested, but did not yield persuasive correlations.

        In other words, not only were Chinese respondents more “AI optimist” in general, but they also had a more mechanistic view of legal interpretation, which likely made them more amenable to the judicial use of “thinking machines.” Combined, these two patterns suggest that Chinese respondents were more likely to embrace a highly modernist worldview that valorizes legally rational state-building and technological growth as solutions to present-day sociopolitical problems.
        - Current draft available [here](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7129379)
        {{< /spoiler >}}
        - ###### {{< spoiler text="The Politics of Capital City Lawyering: A Comparison of Chinese and U.S. Trade Remedy Lawyers. Under Review." >}}
        This Article recasts the “Washington lawyer” as a species of “capital city lawyer:” private practitioners who are physically based in capital cities and whose legal practice involves regular interactions with the government. Through an examination of trade remedy lawyers in Washington, D.C. and Beijing, I illustrate how physical proximity to and reliance on the government for work affect the development and viability of capital city practice. Whereas Washington trade remedy lawyers see a lucrative and sustainable practice area that is even buoyed by rising trade tensions, the Beijing trade bar is far more pessimistic, with many shifting their focus to otherwise unrelated practice areas. Beijing trade lawyers largely connected their negative prospects to the comparatively distinct ways in which the Chinese government has managed the volume and direction of trade remedy investigations. By highlighting how proximity to the state can be both boon and barrier to capital city lawyers, I open the door to future research on this segment of the bar and call for further cross-national comparisons of state-professional relations.
        {{< /spoiler >}}
        - ###### {{< spoiler text="Beyond Steel: The Diversity of U.S. Trade Remedy Users" >}}
        This paper complicates the conventional wisdom about the relative strength of repeat players in legal processes and the resulting inequalities. Through an examination of petitioners who mobilized the U.S. antidumping and countervailing duty (AD/CVD) laws since 2002, I find that first-time and one-timer users of this complex, costly, and technical administrative process are more prevalent, wide-ranging, and successful that we would otherwise expect. In addition to providing a more comprehensive picture of patterns of participation, my findings point to the likely importance of collective petitioning and the impact of another group of repeat players: lawyers and law firms who help to equalize access and outcomes. The findings also tee up future research on the relationship between lawyers, repeat participation, and expected outcomes in other areas of trade law or countries beyond the United States.
        {{< /spoiler >}}
        ...
        {{< /spoiler >}}
        - ###### {{< spoiler text="Lawrence J. Liu. 2026. Opening the Tariff Toolkit: The Demand for U.S. Administrative Trade Remedies. New York University Law Review 101: 520-592." >}}
        ...
        - Awarded the 2025 Jon Van Dyke Paper Award (best paper submitted to the Junior International Law Scholars Association annual meeting)  
        - Link to publication [here](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5710744)        
        {{< /spoiler >}}
        - ###### {{< spoiler text="Lawrence J. Liu. 2026. No More IEEPA Tariffs? The Legal Bases of an Alternative Regime. Minnesota Law Review Headnotes 110: 89-120." >}}
        ...
        - Link to publication [here](https://papers.ssrn.com/abstract=6213518)
        {{< /spoiler >}}
